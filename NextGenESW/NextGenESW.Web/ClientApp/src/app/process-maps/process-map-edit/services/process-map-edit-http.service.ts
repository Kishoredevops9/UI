...
import { activityBlockSelector, activityConnectorSelector, phaseSelector, selectedProcessMapIdSelector, swimLaneSelector } from '../../process-maps.selectors';
...
@Injectable()
export class ProcessMapEditHttpService extends DiagramHttpService {
