...
@Component({
  selector: 'app-activity-page-search',
  templateUrl: './activity-page-search.component.html',
  styleUrls: ['./activity-page-search.component.scss']
})
export class ActivityPageSearchComponent implements OnInit, AfterViewInit {
  ...
  loadServiceData(){
    if(this.contentType=='M'){ 
      this.activityService.getAllActivityPages().subscribe(
        (data) => {
