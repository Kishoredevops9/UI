...
export class ActivityAddComponent implements OnInit {
  ...
  objData: any;
  // activityTypes = [
  //   { type: 'Decision', activityTypeId: 4 },
  //   { type: 'Terminator', activityTypeId: 5 },
  //   { type: 'Milestone', activityTypeId: 6 },
  //   { type: 'Start', activityTypeId: 2},
  //   { type: 'End', activityTypeId: 3},
  // ];
  autofill: boolean;
  ...
  constructor(
    ...
    this.swimLaneId = data.swimLaneId;
    this.ssID = data.swimMapID;
    this.model = data.model;
    this.editActivityDataObj = data.editShapedata;
    this.editShapeMapView = data.editShapeMap;
    this.milestoneActvities = data.milestoneActvities;
  ...
  ngOnInit(): void {
    this.processMapsService.GetAllActivity().subscribe(
      (data) => {this.activityAdd = data;
        console.log('this.activityAdd', this.activityAdd);
    ...
    if (this.autofill) {
      this.activityForm.patchValue({
        ...
        type: this.activityAdd[this.activityTypeId],
        swimLaneId: Number.parseInt(this.groupId),
      });
    }

    if (this.editActivityDataObj.id != undefined) {
      this.activityForm.patchValue({
