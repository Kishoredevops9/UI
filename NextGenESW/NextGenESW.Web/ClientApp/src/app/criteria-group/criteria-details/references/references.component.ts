...
export class ReferencesComponent implements OnInit {
  ...
  @Input() globalData;
  loading = false;
  @Output() updateReferenceField = new EventEmitter();
  constructor(
    ...
    if (
      ...
      if (!(Object.keys(this.globalData).length === 0)) {
        ...
        this.requiredReferences =
          event.globalData.currentValue.requiredReferences;
        this.informationalReferences =
          event.globalData.currentValue.informationalReferences;
        this.loading = false;
      }
    }
  }
      ...
      this.criteriaGroupService
        ...
        .subscribe((data) => {
          ...
          const referenceObj = {
            ...
            informationalReferences: this.informationalReferences,
            propertiesLastUpdateDateTime: data['propertiesLastUpdateDateTime']

          }
          this.updateReferenceField.emit(referenceObj);
        });
    }
  }
